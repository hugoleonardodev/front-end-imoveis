  ...
  return (
    <section className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="w-[414px] h-[78px] relative bg-white rounded-[78px] shadow">
        <div className="left-[62px] top-[14px] absolute text-neutral-700 text-sm font-bold font-['Source Sans Pro'] leading-tight">Localização</div>
...

      {
        shouldShowOptions ?
          (<ul className="w-[302px] h-[352px] pt-3 pb-2 bg-white rounded-2xl flex-col justify-end items-center gap-3 inline-flex">
            <div className="text-zinc-400 text-sm font-normal font-['Source Sans Pro'] leading-tight">Busque por cidade, região, bairro ou código</div>
