  ...
  (
    ...
    const buttonClass = classNames(
      ...
      'border',
      {
        ...
        // 'bg-white': typeof outlined === 'boolean' && variant === 'primary',
        ...
        'text-white': typeof outlined !== 'boolean' && variant === 'primary',
        ...
        'hover:bg-purple-300': typeof outlined === 'boolean' && (variant === 'primary' || variant === 'secondary'),
